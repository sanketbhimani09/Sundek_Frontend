...
function DetailOrder() {
    ...
    useEffect(() => {
        const fetchOrderDetails = async () => {
            try {
                const response = await fetch(`https://sundek-backend.onrender.com/orderList/${id}`);
                if (!response.ok) {
                        ...
                        <div className="card card-5">
                            ...
                            <div className="card-body">
                                ...
                                <div className="d-flex justify-content-center">
                                    <button className="btn btn--radius-2 btn-dark btn-lg mr-2" type="button" onClick={() => navigate(-1)}>
